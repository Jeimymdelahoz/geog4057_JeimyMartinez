...
def json2shape(input_json = None,workspace = None,fcname = None, wkid = 4326):
    """
    Covert JSON data to a shapefile using Arcpy.
...
if __name__ == "__main__":
   fcname = 'notax_fc_2.shp'
   workspace = r'C:\Users\jemad\Documents\Documents\LSU\4th Semester_Fall 2025\GEOG 4057_GIS Programming\geog4057-main'
   json2shape(input_json = r"C:\Users\jemad\Documents\Documents\LSU\4th Semester_Fall 2025\GEOG 4057_GIS Programming\geog4057-main\project\data\no_tax.json",
              workspace=workspace,
              fcname=fcname,
              wkid=4326)